...
FEW_SHOT_EXAMPLES = [
    {
        ...
        "score_percent": 33,
        "interpretation": "In the competency of Passion, the candidate has reached a Foundation level of proficiency. The candidate shows a genuine connection to their work and can identify aspects of their professional role that they find personally meaningful. At this level, motivation is present but tends to be individually focused and activated within familiar or well-suited conditions, rather than consistently self-generated across situations. This reflects an emerging stage of engagement, where enthusiasm exists but has not yet extended toward a wider commitment to collective goals or organizational purpose.",
    },
    {
...
V7_FEEDBACK_SYS = (
    ...
    "reached/attained a <achieved level> level of proficiency.' Use the achieved level name "
    "exactly as it appears in the assessment result — do not rename or re-band it.\n"
    ...
    "individually focused, exploratory, proactive/strategic), and — at the lower levels — "
...
V7_COMP_USER = (
    ...
    "Framework facts:\n{facts}\n\n"
    "Produce the structured competency report. "
    "'interpretation' = a full, constructive narrative in the SAME STYLE as the worked examples: "
    "open with 'In the competency of {competency}, the employee has reached/attained a <level> "
    "level of proficiency', then describe in "
...
V7_EXEC_SYS = (
    ...
    "as 'the employee'.\n"
    "Use ONLY the factual results table (levels, scores, counts) — never "
...
V7_EXEC_USER = (
    ...
    "Describe any 0% result as 'not yet demonstrated'."
)
